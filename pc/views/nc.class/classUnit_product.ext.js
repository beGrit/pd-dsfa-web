    ...
    methods: {
      ...
      subSelect(res, type) {
        ...
        _.forEach(data, function (d) {
          $table.pushRow({
            'nc_pack_unit_sub.name': d['nc_courses_info_selectsource.title'],
            'nc_pack_unit_sub.period': d['nc_courses_info_selectsource.period'],
            'nc_pack_unit_sub.business_id': d['_id'],
            'nc_pack_unit_sub.type': type
          })
        });
      },

      courseSelect: function (res) {
        let type = {
          text: "课程",
          value: "course"
        };
        this.subSelect(res, type)
      },

      examSelect: function (res) {
        let type = {
          text: "考试",
          value: "exam"
        };
