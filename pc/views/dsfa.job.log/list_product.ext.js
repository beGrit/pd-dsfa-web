  ...
  return {
    ...
    methods: {
      showLog: function (res) {
        var data = res.data;
        var url = data['dsfa_job_log_findlogsjy.executor_address'] + '/job/api/log?path=' + encodeURIComponent(data['dsfa_job_log_findlogsjy.trigger_time'].split(' ')[0] + '/' + data._id + '.log')
