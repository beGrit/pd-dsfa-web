dsf.define(function () {
  return {
    ...
    methods: {
      tabClick(tab) {
        if (tab.name == 'kc' || tab.name == 'jy') { // 课程
          this.$el.childNodes[1].children[0].children[1].style.width = "100%";
          this.$el.childNodes[1].children[0].children[2].style.display = "none";
        } else {
          this.$el.childNodes[1].children[0].children[1].style.width = "calc(100% - 410px)";
          this.$el.childNodes[1].children[0].children[2].style.display = "block";
        }
      },
    }
  }
