dsf.define(function () {
  return {
    ...
    methods: {
      ...
      // 用户选择
      userSelector(data) {
        this.selectorPut(data.args, "service_reade_receives.id", function (r) {
          if (r.children) return;
          return {
            "service_reade_receives.user_id": r._id,
            "service_reade_receives.name": r._name,
            "service_reade_receives.state": {
              text: '未读',
              value: '0'
            }
          }
