dsf.define(function () {
  return {
    ...
    methods: {
      ...
      // 用户选择
      userSelector(data) {
        this.selectorPut(data.args, "service_announcement_receives.id", function (r) {
          if (r.children) return;
          return {
            "service_announcement_receives.user_id": r._id,
            "service_announcement_receives.name": r._name,
            "service_announcement_receives.state": {
              text: '未查看',
              value: '0'
            }
          }
