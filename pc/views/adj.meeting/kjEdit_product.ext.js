    ...
    methods: {
      sub: function (res) {
        ...
        _.forEach(data, function (d) {
          $table.pushRow({
            'adj_meeting_sub.kj_name': d['nc_kck_jbxx_kjcxzsjy.kjmc'],
            'adj_meeting_sub.kj_type': d['nc_kck_jbxx_kjcxzsjy.kjlx_text'],
            'adj_meeting_sub.kj_type_value': d['nc_kck_jbxx_kjcxzsjy.kjlx_value'],
            'adj_meeting_sub.kj_id': d['nc_kck_jbxx_kjcxzsjy.nc_kjc_id']
          })
        });
      }
