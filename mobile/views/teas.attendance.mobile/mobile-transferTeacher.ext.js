dsf.define(function () {
  return {
    ...
    created: function () {},
    mounted: function () {
      var currentClassInfo = sessionStorage.getItem('currentClassInfo')
      if (currentClassInfo) {
        var classId = JSON.parse(currentClassInfo)
          .classId
        this.$http
          .get('teas/mobile/attendance/teaAttendManagePageRedirect', {
            classId: classId
          })
          .done((res) => {
            if (res.success && res.state == 20000 && res.data) {
