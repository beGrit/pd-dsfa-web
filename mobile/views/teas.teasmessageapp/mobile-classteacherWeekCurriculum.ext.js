dsf.define(function () {
  return {
    ...
    computed: {},
    created: function () {
      var currentClassInfo = dsf.storage.session.get('currentClassInfo', '{}', true);
      if (currentClassInfo) {
        currentClassInfo = JSON.parse(currentClassInfo);
        this.url = '/teas/schedule/course/possiblecourses/getClassCourseByTime?classId=' + currentClassInfo.classId;
      }
    },
    mounted: function () {},
    activated: function () {},
