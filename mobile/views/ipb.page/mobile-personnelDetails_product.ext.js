  ...
  return {
    ...
    methods: {
      ...
      settingAdmin: function () {
        this.$http.post("/mobile/person/admin", {
          ...
          .then(function ({
            ...
            if (data.state === 20000) {
              dsf.layer.message("设置管理员成功");
            } else {
              dsf.layer.message("设置管理员失败");
            }
          });
      },
      // 移除
      removePersonnel: function () {
        var that = this;
        this.$http.post("/mobile/person/remove", {
            id: this.$viewData["_id"]
          })
          .then(function ({
            data
            ...
            if (data.state === 20000) {
              dsf.layer.message("移除成功");
              setTimeout(function () {
                that.$router.replace("/mobile/ipb/page/mobile-personManagement");
              }, 2000);
            } else {
              dsf.layer.message("移除失败");
            }
          });
      }
    }
