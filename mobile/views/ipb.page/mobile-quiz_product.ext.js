dsf.define(function () {
  return {
    ...
    methods: {
      ...
      submit: function () {
        var plnr = this.$viewData['ipb_page.plnr']
        if (plnr.trim() === '' || this.clickFlag) return;
        var url = '/dsfa/platform/comment/addOrRefreshComment'
        var baseUrl = $$webRoot.dsfa
        var params = {
          dsfaCommentId: '',
          treeinfoPid: '',
          plnr: plnr,
          ywlxValue: 'kc_pl',
          ywid: this.queryString.id,
          ywTitle: '',
          img: JSON.stringify([]),
