dsf.define(function () {
  return {
    ...
    watch: {
      '$route': function (to) {
        if (to.path == '/mobile/nc/page/app/recommend/mobile-recommendPage' && to.query.active) {
          this.active = to.query.active;
          this.$refs.navtab1.tabChange({
            name: to.query.active
          });
        }
      }
    },
    created: function () {
      this.active = this.queryString['active'] || 'course';
    },
    mounted: function () {},
    activated: function () {},
    ...
    ready: function () {
      // this.$refs.navtab1.tabChange({
      //   name: this.queryString['active'] || 'course'
      // })
    },
