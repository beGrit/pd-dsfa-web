...
!(function(e, t) {
    ...
    if (s)
      if ("string" == typeof s) {
        ...
        if (d.indexOf("<") >= 0 && d.indexOf(">") >= 0) {
          ...
          for (
            o = a || "#" !== s[0] || s.match(/[ .<>:~]/) ? (a || e).querySelectorAll(s.trim()) : [e.getElementById(s.trim().split("#")[1])], n = 0; n < o.length; n += 1
          )
            o[n] && r.push(o[n]);
      ...
      return (
        ...
        (n.setTransition(t),
          ...
          ((n.animating = !0),
            ...
            n.$wrapperEl[0].addEventListener("webkitTransitionEnd", n.onTranslateToWrapperTransitionEnd))), !0
      );
    },
  };
  var c = {
  ...
  var m,
    ...
    ((m = t.navigator.platform),
      ...
      (b.webView = !(!(S || T || E) || (!g.match(/.*AppleWebKit(?!.*Safari)/i) && !t.navigator.standalone)) ||
            ...
            if (
              ...
              if (
                (a.touchReleaseOnEdges && (g = 0),
                  ...
                  m && (l.preventedByNestedSwiper = !0), !this.allowSlideNext &&
  ...
  function A(e) {
    ...
    if (
      ((i.isTouched = !1),
        (i.isMoved = !1),
        (i.startMoving = !1),
        (p = s.followFinger ? (r ? t.translate : -t.translate) : -i.currentTranslate), !s.cssMode)
    )
      if (s.freeMode) {
  ...
  function H() {
    var e = this.wrapperEl;
    (this.previousTranslate = this.translate),
    (this.translate = this.isHorizontal() ? -e.scrollLeft : -e.scrollTop), -0 === this.translate && (this.translate = 0),
  ...
  var ie = {
      ...
      normalize: function(e) {
        ...
        return (
          ...
          s && !t && (t = s < 1 ? -1 : 1),
          a && !i && (i = a < 1 ? -1 : 1), { spinX: t, spinY: i, pixelX: s, pixelY: a }
        );
      },
      ...
      handle: function(e) {
        ...
        var r = i.$el;
        if (
          ("container" !== i.params.mousewheel.eventsTarged && (r = s(i.params.mousewheel.eventsTarged)), !i.mouseEntered && !r[0].contains(t.target) && !a.releaseOnEdges)
        )
          return !0;
      ...
      animateSlider: function(e) {
        return (
          ...
          (e.direction < 0 ?
            ...
            (this.mousewheel.lastScrollTime = new t.Date().getTime()), !1)
        );
      },
    ...
    ae = {
      ...
      render: function() {
        ...
        if (e.el && this.pagination.el && this.pagination.$el && 0 !== this.pagination.$el.length) {
          ...
          if ("bullets" === e.type) {
            for (
              var a = this.params.loop ? Math.ceil((t - 2 * this.loopedSlides) / this.params.slidesPerGroup) : this.snapGrid.length, r = 0; r < a; r += 1
            )
              e.renderBullet ?
          ...
          if (!(r < i.slideWidth && o < i.slideHeight)) {
            if (
              ((s.minX = Math.min(i.slideWidth / 2 - r / 2, 0)),
                ...
                (s.touchesCurrent.y = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY), !s.isMoved && !t.isScaling)
            ) {
              if (
                this.isHorizontal() &&
      ...
      load: function() {
        ...
        if (o.loadPrevNext)
          if (l > 1 || (o.loadPrevNextAmount && o.loadPrevNextAmount > 1)) {
            for (
              var c = o.loadPrevNextAmount, u = l, v = Math.min(r + u + Math.max(c, u), a.length), f = Math.max(r - Math.max(u, c), 0), m = r + l; m < v; m += 1
            )
        ...
        on: {
          ...
          click: function(e) {
            ...
            !this.params.navigation.hideOnClick ||
              s(e.target).is(r) ||
              s(e.target).is(a) ||
              (a ? (t = a.hasClass(this.params.navigation.hiddenClass)) : r && (t = r.hasClass(this.params.navigation.hiddenClass)), !0 === t ? this.emit("navigationShow", this) : this.emit("navigationHide", this),
